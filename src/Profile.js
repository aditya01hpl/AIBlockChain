...
/*const auth = 'Basic ' + Buffer.from("Aditya:2XSE1ydz3B8UDGe5cWedRUsQSpL").toString('base64');
const client = ipfsHttpClient({
    host: 'ipfs.infura.io',
    port: 5001,
    protocol: 'https',
    headers: { authorization: auth }
    /b350d4a89309997b532f8d45a6107377
});*/


const client = ipfsHttpClient('https://ipfs.infura.io:5001/2XSE1ydz3B8UDGe5cWedRUsQSpL/Aditya')
